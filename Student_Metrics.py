...
st.set_page_config(page_title='Institution SU Student Dashboard',layout='wide')

st.title('Institution SU - Student Dashboard')
...
df_engagement_attendance = pd.read_csv('./student-data/institution-su-engagement-data.csv',parse_dates=['start_date','end_date'])
#df_test_scores = pd.read_csv('./student-data/institution-su-test-data.csv',parse_dates=['test_date'])
